   ...
   //Hej med dig
    public MainWindow()
    {
        ...
        ProductsList.ItemsSource = new ObservableCollection<Products>
        {
            ...
            new Products("Dell XPS 15", "Powerful Windows laptop", 1234567910112, 3, 1899.99 , "avares://arneselectronics/Assets/MSILabTop.jpg"),
            ...
            new Products("Asus ROG Strix", "Gaming laptop med RTX 4070", 1234567910116, 7, 2199.00 , "avares://arneselectronics/Assets/SSD.jpg"),
            new Products("Google Pixel 8", "Stock Android med fantastisk kamera", 1234567910117, 8, 899.00 , "avares://arneselectronics/Assets/PC.jpg"),
            new Products("Apple Watch Series 9", "Smartwatch med sundhedstracking", 1234567910118, 9, 499.99 , "avares://arneselectronics/Assets/PC.jpg"),
            new Products("Logitech MX Master 3", "Trådløs præcisionsmus", 1234567910119, 10, 99.99 , "avares://arneselectronics/Assets/PC.jpg"),
            new Products("HP Spectre x360", "2-i-1 premium ultrabook", 1234567910120, 11, 1599.00 , "avares://arneselectronics/Assets/PC.jpg"),
            new Products("Razer BlackWidow V4", "Mekanisk gaming keyboard", 1234567910121, 12, 149.99 , "avares://arneselectronics/Assets/PC.jpg"),
            new Products("Corsair K100 RGB", "Hurtigt gaming tastatur med optiske switches", 1234567910122, 13, 229.99 , "avares://arneselectronics/Assets/PC.jpg"),
            new Products("Samsung 980 Pro SSD", "1TB NVMe SSD med høj hastighed", 1234567910123, 14, 129.99 , "avares://arneselectronics/Assets/PC.jpg"),
            new Products("Apple AirPods Pro 2", "Trådløse høretelefoner med ANC", 1234567910124, 15, 249.99 , "avares://arneselectronics/Assets/PC.jpg"),
